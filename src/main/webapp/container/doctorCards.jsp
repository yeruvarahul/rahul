<%@page import="com.entity.doctorPatient"%>
<html>
    <head>
                        ...
                        <div class="card-flyer">
                            <div class="text-box">
                                ...
                                <div class="text-container">
                                    <%
                                        doctorPatient dp=(doctorPatient) session.getAttribute("doctorPatient");
                                        if(dp==null){ %>
                                        <h6>Name</h6> 
                                        <%
                                        }else{%>
                                        <h6><%=dp.getFirstname()%> <%=dp.getLastname()%></h6> 
                                        <%
                                        }
                                        %>
                         <p><strong>Email-</strong><%=dp.getEmail()%></p>
                                        <p><strong>Address-</strong><%=dp.getAddress()%></p>
                                        <p><strong>Id-</strong><%=dp.getId()%></p>
                                </div>
                            </div>
                        </div>
                    </a>
